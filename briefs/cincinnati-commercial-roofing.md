...
**/cincinnati/commercial-roofing/** · currently `noindex` — no market-specific copy.
...
- **H1** — `Commercial Roofing in Cincinnati`. Written, unique across markets, do not rewrite.
...
Target: **398+ words** of market-specific copy, in `SERVICE_CONTENT.["commercial-roofing"].local["cincinnati"]`.
