...
**/st-louis/gutters/** · currently `noindex` — no market-specific copy.
...
- **H1** — `Gutters in St. Louis`. Written, unique across markets, do not rewrite.
...
Target: **398+ words** of market-specific copy, in `SERVICE_CONTENT.gutters.local["st-louis"]`.
