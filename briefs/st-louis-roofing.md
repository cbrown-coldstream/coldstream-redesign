...
**/st-louis/roofing/** · currently `noindex` — no market-specific copy.
...
- **H1** — `Roofing in St. Louis`. Written, unique across markets, do not rewrite.
...
Target: **398+ words** of market-specific copy, in `SERVICE_CONTENT.roofing.local["st-louis"]`.
