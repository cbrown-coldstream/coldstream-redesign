# Garage Doors in St. Louis

**/st-louis/garage-doors/** · currently `noindex` — no market-specific copy.

Market: **St. Louis** (Greater St. Louis) · phone (314) 380-8111 · office 3636 S Geyer Rd #100, St. Louis, MO 63127

## What already exists on this page

- **H1** — `Garage Doors in St. Louis`. Written, unique across markets, do not rewrite.
- **Shared lead** — Installation and replacement, usually alongside a roofing or siding project so it is one crew and one schedule.
- **2 service sections** — Installation · Replacement
- **1 shared FAQ answers** — these stay; the local ones go above them.

## What has to be written

Target: **398+ words** of market-specific copy, in `SERVICE_CONTENT.["garage-doors"].local["st-louis"]`.
