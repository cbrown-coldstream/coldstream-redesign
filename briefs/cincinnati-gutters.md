# Gutters in Cincinnati

**/cincinnati/gutters/** · currently `noindex` — no market-specific copy.
...
Target: **398+ words** of market-specific copy, in `SERVICE_CONTENT.gutters.local["cincinnati"]`.
