...
**/columbus/windows/** · currently `noindex` — no market-specific copy.
...
- **H1** — `Replacement Windows in Columbus`. Written, unique across markets, do not rewrite.
...
Target: **398+ words** of market-specific copy, in `SERVICE_CONTENT.windows.local["columbus"]`.
