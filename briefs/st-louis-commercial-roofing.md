# Commercial Roofing in St. Louis

**/st-louis/commercial-roofing/** · currently `noindex` — no market-specific copy.
...
Target: **398+ words** of market-specific copy, in `SERVICE_CONTENT.["commercial-roofing"].local["st-louis"]`.
...
- This hub exists in Cincinnati and Columbus only. St. Louis was ruled to have no commercial roofing.
