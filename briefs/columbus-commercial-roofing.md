...
**/columbus/commercial-roofing/** · currently `noindex` — no market-specific copy.
...
Target: **398+ words** of market-specific copy, in `SERVICE_CONTENT.["commercial-roofing"].local["columbus"]`.
