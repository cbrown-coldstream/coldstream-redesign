...
const commonFaq = () => [
  ...
  { q: "Who actually does the work?", a: "Our own crews, in every market we run. The person who quotes the job is on the job, and we do not hand your house to a subcontractor we have not met." },
...
export const NATIONAL_SUBSERVICES = {
  roofing: {
    ...
    replacement: {
      ...
      description: "Full tear-off roof replacement by our own crews. Decking inspected, ventilation balanced, new flashing throughout, and a 25-year workmanship warranty.",
    ...
    repair: {
      ...
      description: "Leak tracing, flashing and storm repairs by our own crews. We find where the water is actually getting in, and say so when a repair is not the honest answer.",
