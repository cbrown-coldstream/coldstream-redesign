...
export const NATIONAL_SUBSERVICES = {
  roofing: {
    ...
    repair: {
      ...
      faq: [
        ...
        { q: "Can you match my existing shingles?", a: "Often closely, rarely perfectly. Colors are discontinued and the roof around them has weathered. We will tell you how visible a patch is likely to be before we do it." },
  ...
  siding: {
    ...
    "vinyl-siding": {
      ...
      description: "Vinyl siding installed so it can move, over a water barrier we inspected first — installation is what most vinyl complaints trace back to. Free quote.",
      ...
      sections: [
        { title: "Hung loose, not pinned", body: "Nailed to allow movement, with the fastener centered in the slot and left slightly proud. Room left at the end of every run. This single detail is most of the difference between vinyl that lasts and vinyl that waves." },
      ...
      depth: {
        ...
        blocks: [
          ...
          { h: "Color, fade and the matching problem",
            p: ["Darker colors absorb more heat and shift sooner, and a south or west elevation ages ahead of the rest of the house regardless of color. Modern formulations hold far better than they used to, but the sunny wall still shows age first.",
                "Matching matters later rather than now. Profiles and colors get discontinued, so a partial repair on a wall that is ten years old often cannot be matched exactly. We will tell you when a patch is going to be visible instead of fitting it and letting you notice."] },
        ],
      },
      process: [
        ...
        { title: "Product and color", body: "Profile and color held against your roof and trim in daylight rather than picked from a chart." },
      ...
      faq: [
        ...
        { q: "Will it fade?", a: "Modern vinyl holds color far better than it once did, and darker colors hold it least well. We will tell you which of your choices is most likely to shift." },
        { q: "Can you match my existing siding?", a: "Sometimes. Profiles and colors get discontinued, so an exact match on an older house is not always possible — we check before promising it." },
        { q: "Vinyl or fiber cement?", a: "Vinyl costs less and is perfectly good installed well. Fiber cement costs more, lasts longer, holds color better and takes an impact without cracking. We quote both." },
        ...commonFaq(),
      ],
    },
    ...
    "james-hardie-siding": {
      ...
      description: "James Hardie fiber cement siding installed to the clearances the warranty depends on. Holds color, takes a knock, and does not soften in heat.",
      h1: "James Hardie fiber cement siding",
      lead: "The material we recommend most often — it holds its color, it takes a knock, and it does not soften in the heat.",
      ...
      sections: [
        { title: "Why fiber cement", body: "It holds color, stands up to impact, does not soften in heat, and gives insects nothing to eat. It costs more than vinyl up front and lasts longer." },
        { title: "ColorPlus or site-painted", body: "Factory-applied finishes arrive consistent and hold longest. Site painting gives you any color you like. We quote both and say which we would choose." },
      ...
      depth: {
        ...
        blocks: [
          ...
          { h: "ColorPlus or site-painted",
            p: ["A factory finish is baked on, arrives consistent across every plank, and holds longest. Site-painted means primed board finished on the wall: it costs less, it lets you pick any color at all, and the finish is only ever as good as the conditions on the day it went on.",
                "Neither is wrong. Factory finish for longevity and consistency, site paint for color freedom or for matching something that already exists. We will quote either and tell you which we would put on our own house."] },
      ...
      process: [
        ...
        { title: "Finish and color", body: "ColorPlus or site-painted, with samples held against your roof and trim in daylight." },
      ...
      faq: [
        { q: "Hardie or vinyl?", a: "Hardie costs more up front, lasts longer, holds color better and takes an impact without cracking. Vinyl costs less and is perfectly good when installed well. We quote both and let you decide." },
        ...
        { q: "Is it worth the extra over vinyl?", a: "On most houses we think so, for the color retention and the impact resistance. On a rental or a short hold, vinyl fitted well is a sound decision and we will say so." },
        ...commonFaq(),
      ],
    },
      ...
      depth: {
        ...
        blocks: [
          { h: "Adhered veneer is a facing, not a wall",
            p: ["Manufactured stone veneer is cast from cement and lightweight aggregate, colored through the body, and bonded to the wall through lath and mortar rather than stacked on a foundation. Nothing above it rests on it, and it carries no structural load.",
          ...
          { h: "Choosing it, and where to use it",
            p: ["Manufactured veneer is lighter, cheaper and easier to fit than natural stone, and the good ranges are convincing at the distance anyone actually stands. Natural thin stone costs more, weighs more and reads differently up close on a porch or an entry where people are within arm's length.",
                "As for how much: stone tends to look most convincing where a real stone wall would plausibly have been — a base, a pier, a chimney — rather than applied evenly across a whole elevation. We will lay it out against your roof and trim colors before anything is ordered."] },
        ],
      },
      process: [
        ...
        { title: "Layout and product", body: "Style, color range and where the stone stops, held against your roof and trim rather than chosen from a chart." },
