    ...
    "vinyl-siding": {
      ...
      faq: (m, c) => ({
        ...
        columbus: [
          ...
          { q: "Does new vinyl help resale?", a: "Fresh, straight siding is one of the highest-visibility exterior updates a listing can carry, and in subdivisions where every third house shows tired original panels, the contrast does real work. We will not invent a return percentage — but ask any local agent which houses photograph better. If a sale is the plan, tell us: the quote can prioritize the elevations the listing photos will lead with, and sequence the rest to your timeline." },
        ],
        "st-louis": [
